...
public class MazeFrame extends JFrame {
	...
	if (mazeType.equals("maze1"))
	    setMessage("Start on the green square and finish on the red square. Each square has a number that indicates how far you must move, horizontally or vertically, when you leave the square.");
	else if (mazeType.equals("maze2"))
	    setMessage("Start on the green square and finish on the red square. Each square has a number that indicates how far you must move, horizontally or vertically, when you leave the square, but do not make a U-turn. On any move after the first, you must continue in the same direction as the last move or go left or right. You cannot go back in the direction you just came from.");
	else if (mazeType.equals("maze3"))
	    setMessage("Start on the green square and finish on the red square. Begin each move by following one of the arrows in the square you are on, and travel a straight line for a distance equal to d. At the start, d equals 1. When you land on a red arrow, 1 is added to d. When you land on a yellow arrow, 1 is subtracted from d.");
	else if (mazeType.equals("maze4"))
	    setMessage("Start on the green square and finish on the red square. Follow the arrow in the square you are on, alternating between red and blue arrows. You may escape the maze when you arrive at an arrow that points to the green square.");
    }
