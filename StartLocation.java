...
public class StartLocation extends Location {
    ...
    public StartLocation(Scanner sc, int i, int j, TheGame g, String maze) {
	super(i, j);

	if (maze.equals("maze1")) {
	    trans = new Transition1(sc, this);
	    button = new MazeButton12(Color.yellow, trans.getVal());
	}
	    ...
	    button = new 
		MazeButton3(Color.yellow, trans.getVal(), trans.getArrows());
	}
	else if (maze.equals("maze4")) {
	    trans = new Transition4(sc, this);
	    button = new
		MazeButton4(Color.yellow, trans.getVal(), trans.getArrows());
	}
